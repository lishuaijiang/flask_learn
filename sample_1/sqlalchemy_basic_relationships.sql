...
VALUES
  (1, 'xiedandan', 'dan07@example.com', 'hC(E6L#nDe', '2001-09-03 23:11:46'),
  (2, 'zhaishuzhen', 'qkong@example.org', '(7jIOCxnwz', '2003-10-18 08:49:42'),
  (3, 'libo', 'pingfeng@example.org', '05sZSVnQ*K', '2009-10-05 11:15:33'),
  (4, 'shigang', 'na29@example.org', '5BHL)xfx#S', '2017-08-05 02:30:35'),
  (5, 'wulihua', 'guiying10@example.net', 'PM2P6PXh(5', '2022-01-28 14:31:03'),
  (6, 'mahongxia', 'xiazhao@example.org', 'mn4HJb#&K!', NOW());
